        ...
        return (
          <div key={todo.id} className="flex w-[335px] mb-2 items-center">
            ...
            <button
              ...
              className="active:bg-rose-500 hover:bg-rose-500 active:text-white border border-rose-500 px-2 hover:text-white text-rose-500 font-semibold pt-[2px] rounded-md"
            >
              Delete
            </button>
          </div>
